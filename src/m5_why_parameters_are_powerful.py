...
def main():
    ...
    # -------------------------------------------------------------------------
    even_better_draw_circles(rg.Point(100, 100), 15, 10, 'green', 5)
    even_better_draw_circles(rg.Point(-100, 100), 15, 10, 'green', 5)
    even_better_draw_circles(rg.Point(0, -100), 15, 8, 'red', 5)
    even_better_draw_circles(rg.Point(0, 0), 15, 15, 'blue', 5)
...
def better_draw_circles(point, c):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(c * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, c, n_circles, pen_color, thickness):
    ...
    for k in range(n_circles):  # k becomes 1, 2, 3, ... n_circles
